 ...
 ***************************************************************************************************/
void oledSendCommand(int cmd);
void oledSendStart(int address);
void oledSendStop(void);
void oledWaitForAck(void);
void oledSendByte(int ch);
/**************************************************************************************************/
...
/***************************************************************************************************
               void OLED_ScrollMessage(int v_lineNumber_u8, char *ptr_msgPointer_u8)
 ****************************************************************************************************
 * I/P Arguments:
                  int  : Line number on which the message has to be scrolled
 ...
 * I/P Arguments:
                  int :  specifies type of number C_BINARY_U8(2),C_DECIMAL_U8(10), C_HEX_U8(16)
                  int: Number to be displayed on the LCD.
...
/***************************************************************************************************
                         void OLED_GoToLine(int v_lineNumber_u8)
 ****************************************************************************************************
 * I/P Arguments: int: Line number(0-7).
 * Return value    : none
 ...
 ****************************************************************************************************/
void OLED_SetCursor(int lineNumber,int cursorPosition)
{
...
/***************************************************************************************************
    void OLED_DisplayHorizontalGraph(int barGraphNumber, int percentageValue)
 ****************************************************************************************************
 * I/P Arguments   : barGraphNumber : position of bar ( 0 to 3 )
                     percentageValue : value of the bar in percentage(0-100)
 * Return value    : none
 ...
 ****************************************************************************************************
 * I/P Arguments   : int: brightness level from 0-255.
 * Return value    : none
...
void oledWaitForAck()
{
    SDA_PIN = 1; //Configure SDA_PIN as Input to read the ACK                //delay_us(1);
    SCL_PIN = 1;
    while(SDA_PIN==1);
    SCL_PIN = 0;
}
