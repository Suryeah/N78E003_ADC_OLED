...
void OLED_GoToPage(int);
void OLED_GoToLine(int);
...
void OLED_VerticalGraph(int var_barGraphNumber_u8, int var_percentageValue_u8);
void OLED_HorizontalGraph(int var_barGraphNumber_u8, int var_percentageValue_u8);
/**************************************************************************************************/   
